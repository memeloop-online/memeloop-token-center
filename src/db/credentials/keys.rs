...
impl Database {
    ...
    pub async fn list_managed_keys_page(
        ...
        self.list_managed_keys_filtered_page(
            tenant_external_id,
            principal_external_id,
            key_id,
            limit,
    ...
    pub async fn list_managed_keys_filtered_page(
        &self,
        tenant_external_id: Option<&str>,
        principal_external_id: Option<&str>,
        key_id: Option<Uuid>,
