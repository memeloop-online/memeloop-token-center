...
pub(in crate::api) fn control_router(state: AppState) -> Router<AppState> {
    let authenticated = Router::new()
        ...
        .route("/internal/v1/oauth/authorization-code/start", post(start_authorization_code_oauth))
        .route("/internal/v1/oauth/authorization-code/complete", post(complete_authorization_code_oauth))
        .route(
        ...
        .route(
            "/internal/v1/generations/quarantine",
            get(super::super::generation_quarantine::list_generation_quarantine),
        )
        .route(
            "/internal/v1/generations/quarantine/{job_id}",
            get(super::super::generation_quarantine::get_generation_quarantine),
        )
        .route(
