...
pub(in crate::api::proxy) enum CandidateCompatibility {
    Compatible,
    ProtocolMismatch,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::api::proxy) enum PreparedRouteReadiness {
    Ready,
    Unavailable,
}
...
pub(in crate::api::proxy) fn candidate_compatibility(
    protocol: Protocol,
...
pub(in crate::api::proxy) async fn refresh_route_snapshot(
    state: &AppState,
...
pub(in crate::api::proxy) fn credential_application_error(
