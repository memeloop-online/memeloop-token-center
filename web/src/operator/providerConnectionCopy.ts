export function providerConnectionCopy(locale: string) {
  return locale.startsWith('zh') ? {
    network: '网络与连接', authentication: '认证', routing: '路由设置',
    readFailed: '无法读取完整代理地址。请确认管理权限后重新打开编辑。',
    ...
    network: 'Network and connection', authentication: 'Authentication', routing: 'Routing settings',
    readFailed: 'Cannot read the full proxy address. Check management permissions and reopen the editor.',
