...
function OAuth({ token, onCreated }: { token: string; onCreated: () => void }) {
  const [mode, setMode] = useState<'subscription' | 'cursor-direct'>('subscription');
