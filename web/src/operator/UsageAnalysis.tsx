...
function NumericMetric({ label, value, tone }: { label: string; value?: number | null; tone?: string }) {
  const { locale } = useI18n(); const formatted = formatMetricDisplay(value, locale);
