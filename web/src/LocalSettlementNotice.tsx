...
export function LocalSettlementNotice() {
  ...
  return <p><DetailTooltip content={detail}><Button appearance="subtle" size="small" type="button">{locale === 'zh-CN' ? '本地结算口径 ⓘ' : 'About local settlement ⓘ'}</Button></DetailTooltip></p>;
}
