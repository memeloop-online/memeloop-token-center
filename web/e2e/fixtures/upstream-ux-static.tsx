...
const snapshot: UpstreamQuotaSnapshot = {
  ...
  status: 'ready', observed_at: Date.now() - 120000, stale_after: Date.now() - 1, stale: true, freshness: 'stale', plan_type: 'Plus', workspace: null,
  ...
  credits: { balance: null, unlimited: false, has_credits: true, source: null }, reset_credits: [],
  windows: [
    { id: 'weekly', label: 'Weekly', used_percent: 83, used: null, remaining: null, limit: null, unit: null, reset_at: Date.now() + 3600000, period_seconds: 604800, source: 'static mock', reset_is_estimated: true, allowed: true, limit_reached: false },
    { id: 'unknown', label: 'Unknown usage', used_percent: null, used: null, remaining: null, limit: null, unit: null, reset_at: null, period_seconds: null, source: 'static mock', reset_is_estimated: false, allowed: null, limit_reached: null },
  ],
  reset_capability: { provider_supported: true, implementation_available: true, prepare_available: true, confirmation_required: true, retryable: false, available_credits: 2, applicable_credits: 1, reason: 'explicit_confirmation_required', credit_error_code: null, evidence: 'server_driver_contract' }, error_code: null,
};
